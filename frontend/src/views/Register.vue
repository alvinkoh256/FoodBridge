   ...
   <div class="big-screen">
     <div class="register-form">
       ...
       <p class="flex flex-col md:flex-row gap-4 w-full">
         ...
         <div class="flex flex-col gap-2 flex-1">
           <label for="phoneNumber" class="text-black font-bold text-left pl-1">Phone No</label>
           <InputMask id="phoneNumber" v-model="phoneNumber" mask="+6599999999" placeholder="+6599999999" />
         </div>
       </p>
       <p class="flex flex-col gap-2">
